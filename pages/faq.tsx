...
const FaqPage: NextPage = () => {
  return (
    <Default pageName="ThreadsDownloader | F.A.Q.">
      <Flex w={'full'} h={'20vh'} backgroundImage="/faq-banner.jpg" justify="center" align="center">
        <Text color="white" fontWeight={600} fontSize={["md", "2xl", "5xl"]} >
          Frequantly Asked Questions
        </Text>
      </Flex>
      <Flex justify="center" py="10" h="fit-content">
        <Tabs borderWidth='2px' rounded='lg' p='6' variant='soft-rounded' isFitted w="50%" boxShadow="0px 0px 15px 5px rgba(0,0,0,0.5)" colorScheme="red">
          <TabList>
            <Tab fontWeight='bold' fontSize={["sm", "md"]}>Frequent questions</Tab>
          ...
          <TabPanels>
            <TabPanel>
              <Accordion>
                <AccordionItem>
                    <AccordionButton>
                      <Box as="span" flex='1' textAlign='left' fontWeight='bold' fontSize={{ base: 'md', md: 'lg', lg: 'xl' }}>
